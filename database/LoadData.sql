...
VALUES ('Intel core i5-1340P (12 lõi, 16 luồng, up to 4.6GHz, 12MB cache)', '16GB LPDDR5 4800MHz', 'SSD 512GB M.2 PCIe NVMe', '16" FHD+ (1920 x 1200; 16:10) Anti-Glare Non-Touch 250nits WVA Display with ComfortView Support', 'Intel Iris Xe Graphics', '4-Cell, 54Wh', '1.85 kg', 'HD camera', 'Window 11 Home', '2x USB 3.2 Gen 1 Type A
       ...
       ('Intel Core i7-1360P (1.6GHz up to 5.0Hz, 12 lõi, 16 luồng, 18MB Cache)', '16GB LPDDR5 4800MHz', 'SSD 512GB M.2 PCIe NVMe', '16" FHD+ (1920 x 1200; 16:10) Anti-Glare Non-Touch 250nits WVA Display with ComfortView Support', 'Intel Iris Xe Graphics', '4-Cell, 54Wh', '1.85kg', 'HD camera', 'Window 11 Home', '2x USB 3.2 Gen 1 Type A
		1x USB Type-C Thunderbolt 4.0 port with DisplayPort and Power Delivery
		1x HDMI 1.4 port
		1x  SD-card slot
		1x Jack tai nghe 3.5mm
		1x Power-adapter port 4.5 mm x 2.9 mm DC-in', FALSE),
       ('Intel core i5-1240P (12 MB cache, 12 lõi, 16 luồng, up to 4.40 GHz Turbo)', '16GB 2x8 GB DDR4 3200MHz', 'SSD 512GB M.2 PCIe NVMe', '16" FHD+ (1920 x 1200; 16:10) Anti-Glare Non-Touch 300nits WVA Display with ComfortView Support, 100% sRGB', 'Intel Iris Xe Graphics', '4-Cell, 54Wh', '1.8kg', '1080p at 30 fps FHD camera', 'Window 11 Home', '2x USB 3.2 Gen 1 ports
		1x USB 3.2 Gen 2x2 Type-C port with DisplayPort and Power Delivery
		1x HDMI 1.4 port
		1x Headset jack', FALSE),
       ('AMD Ryzen 5 8640HS (6-lõi/12-luồng Processor)', '8GB 1x8GB DDR5 5600MHz', 'SSD 512GB M.2 PCIe NVMe', '14" FHD+ (1920 x 1200; 16:10) Touch 250nits WVA Display with ComfortView Support, 100% sRGB', 'AMD Radeon Graphics', '4-Cell, 54Wh', '1.7kg', '720p 30 fps FHD camera', 'Window 11 Home', '1x HDMI 1.4
		2x USB Type-C ( Power Delivery và DisplayPort)
		2x USB Type-A
		1x SD Card Reader
		1x Headphone & Microphone Audio Jack.', FALSE),
       ('Intel Core i5-13420H (2.00GHz up to 4.60GHz 12MB Cache)', '8GB DDR4 3200MHz', 'SSD 512GB, PCIe Gen4, 16 Gb/s, NVMe', '15.6" FHD (1920 x 1080) IPS, 60Hz, Slim Bezel, Acer ComfyView', 'NVIDIA GeForce RTX 2050 4GB GDDR6', '3-Cell, 50Wh', '1.7kg', '1080p at 30 fps FHD camera', 'Window 11 Home', '1 x USB Type-C port supporting: USB 3.2 Gen 2, Thunderbolt™ 4
		2 x USB 3.2 Gen 1 Type-A
		1 x HDMI® 2.1 port with HDCP support
		1 x 3.5 mm headphone/speaker jack, supporting headsets with built-in microphone
		1 x Ethernet (RJ-45) port
		1 x DC-in jack for AC adapter', FALSE),
       ('Intel Core Ultra 5-125H (3.60 GHz up to 4.50 GHz, 18MB Cache, 14 lõi, 18 luồng)', '16GB LPDDR5x 6400MHz', ' SSD 512GB M.2 NVMe', '14" FHD (2880 x 1800) IPS, 120Hz, Slim Bezel, Acer ComfyView 400 nits, 100% sRGB', 'Intel Arc Graphics', '4 cell 65Wh', '1.3kg', 'QHD webcam', 'Window 11 Home', '2 x USB 3.2
		2 x Thunderbolt 4
		1 x micro SD card slot
		Audio combo
		1 x HDM', FALSE),
       ('Core i5-12500H (12 lõi/16 luồng,3,3 Ghz-4,5 Ghz)', '16GB DDR5 4800MHz', 'SSD 512GB NVMe', '15" FHD (1920 x 1080) IPS 144Hz slim bezel LCD', 'NVIDIA GeForce RTX 4050 6GB GDDR6', '4 cell 57Wh', '2.4kg', 'HD webcam', 'Window 11 Home', '1 x USB 3.2 Gen 2 port featuring power-off USB charging
		2 x USB 3.2 Gen 1 ports
		1 x USB Type-C port: USB 3.2 Gen 2 (up to 10 Gbps)
		1 x HDMI® port with HDCP suppor', FALSE),
       ('AMD Ryzen 7-7735HS (8 lõi/16 luồng, 16MB L3 cache, up to 4.7 GHz max boost)', '16GB DDR5 4800MHz', 'SSD 512GB M.2 PCIe Gen4',  '16" FHD+ (1920 x 1200) 165Hz, 7ms, 250 nits, Chống chói, FreeSync Premium, 100% sRGB', 'AMD Radeon RX 7700S 8GB GDDR6', '90WHrs 4S1P, 4-cell Li-ion', '2.2kg', 'HD webcam', 'Window 11 Home', '1x RJ45 LAN
		1x USB 3.2 Gen 2 Type-C (DisplayPort)
		1x USB 3.2 Gen 2 Type-C (DisplayPort / Sạc)
		2x USB 3.2 Gen 1 Type-A
		1x HDMI 2.1 FRL
		1x 3.5mm Combo Audio Jack', FALSE),
       ('Intel Core Ultra 7 155H (24MB Cache, 1.4 GHz up to 4.8 GHz, 16 lõi, 22 luồng); Intel AI Boost NPU', '16GB LPDDR5X 7467MHz', '1TB M.2 PCIe Gen 4 NVMe SSD', '14" FHD (1920 x 1200) OLED 16:10 aspect ratio, 500 nits,  100% DCI-P3 color gamut, Touch screen', 'Intel Arc Graphics', '75WHrs, 2S2P, 4-cell Li-ion', '1.28 kg', 'FHD camera', 'Window 11 Home', '1x USB 3.2 Gen 1 Type-A
		2x Thunderbolt™ 4 supports display / power delivery
		1x HDMI 2.1 TMDS
		1x 3.5mm Combo Audio Jack', FALSE),
       ('Intel Core Ultra 5 125H (2.3 GHz up to 4.5 Hz, 14 lõi, 18 luồng, 18MB Cache)', '16GB LPDDR5x 7467MT/s', 'SSD 512GB PCIe 4.0', '14.5" 2.5K (2560x1600) IPS, LED, 90Hz, 100% sRGB', 'Intel Arc Graphics', '4 cell 85Wh', '1.5 kg', '1080p IR', 'Window 11 Home', '1x USB type C
		1x HDMI 2.1
		1x Thunderbolt
		1x Headphone / mic combo 3.5
		2x USB type A
		1x TGX
		1x Đầu đọc thẻ SD
		1x RJ45', FALSE),
       ('AMD Ryzen 7 7435HS (3.10GHz up to 4.50GHz, 4MB L2 / 16MB L3 Cache)', '16GB DDR5 4800 SODIMM', 'SSD 512GB M.2 2242 PCIe® 4.0x4 NVMe', '15.6" FHD (1920x1080) IPS 300nits Anti-glare, 100% sRGB, 144Hz, G-SYNC', 'NVIDIA GeForce RTX 4050 6GB GDDR6', '4 cell 60Wh', '2.4 kg', 'HD 720p with E-shutter', 'Window 11 Home', '3x USB-A (USB 5Gbps/USB 3.2 Gen 1)
		1x USB-C (USB 10Gbps/USB 3.2 Gen 2), with Lenovo® PD 140W and DisplayPort™ 1.4
		1x HDMI 2.1, up to 8K/60Hz
		1x Headphone/microphone combo jack (3.5mm)
		1x Ethernet (RJ-45)
		1x Power connector', FALSE),
        ('Intel Core i5-13500H (18M Cache, up to 4.70 GHz, 12 lõi, 16 luồng)', '16BG DDR4 3200MHz Soldered, up to 40BG', 'SSD 1TB M.2 PCIe Gen 4 NVMe', '14" 2.2K (2240x1400) IPS 300 nits, Anti-glare, 100% sRGB, 60Hz', 'Intel UHD Graphics', '4 cell 57Wh', '1,43 kg', 'FHD camera', 'Window 11 Home', '1x RJ45
        1x USB-A 3.2(Always On)
		1x USB-A 2.0 
        1x HDMI 2.0
        1x Thunderbolt™ 4', FALSE),
        ('Intel Core i7-8750H', '16GB DDR4 Bus 2666MHz', 'SSD 512GB', '15.6" FHD', 'Intel HD Quadro P2000', '6 Cells', '2.79 kg', 'HD 720p', 'Window 10 Home', 'VGA
        USB 3.0 và 2.0
        LAN
        Display Port', FALSE),
        ('Intel Core i7-7820HQ', '16GB DDR4 Bus 2400MHz', 'SSD 512GB', '15.6" FHD', 'NVIDIA Quadro M2200M 4GB', '6 Cells', '2.6 kg', 'HD 720p', 'Window 10 Home', '4xUSB 3.1 Gen 1
        1xUSB-C (Thunderbolt 3)
        1xHDMI 1.4b
        1xMini DisplayPort 1.2a
        SD Card Reader
        RJ-45
        3.5mm combo jack', FALSE),
        ('Intel Core i5-1135G7 (4 lõi/8 luồng, 2.40 Ghz upto 4.20 Ghz, 8Mb cache)', '8GB DDR4 3200MHz', 'SSD 256GB', '15.6" FHD+', 'Intel Iris Xe graphics', '37WHrs, 2S1P, 2-cell Li-ion', '1.80 kg', 'VGA camera', 'Window 11 Home', '1x USB 3.2 Gen 1 Type-A
...
INSERT INTO laptop (specification_id, name, brand, price, sale, available, state)
VALUES  (1, 'Dell Inspiron 16 5630', 'Dell', 23990000, 33, TRUE, "New"),
        (2, 'Dell Inspiron 16 5630', 'Dell', 26990000, 20, TRUE, "New"),
        (3, 'Dell Inspiron 16 5620', 'Dell', 19990000, 16, TRUE, "New"),
        (4, 'Dell Inspiron 7445 2-in-1 2024', 'Dell', 19990000, 16, TRUE, "New"),
        (5, 'Acer Aspire 5 A515-58GM-53PZ', 'Acer', 19990000, 15, TRUE, "New"),
        (6, 'Acer Swift Go 14 AI SFG14-73-53X7', 'Acer', 23990000, 8, TRUE, "New"),
        (7, 'Acer Nitro 5 AN515-58-56CH', 'Acer', 24990000, 20, TRUE, "New"),
        (8, 'ASUS TUF Gaming A16 Advantage Edition 2023 FA617NT', 'Asus', 27990000, 20, TRUE, "New"),
        (9, 'Asus Zenbook 14 OLED Q425MA 2024', 'Asus', 27990000, 20, TRUE, "New"),
        (10, 'Lenovo Thinkbook 14 G6+ 2024', 'Lenovo', 25990000, 24, TRUE, "New"),
        (11, 'Lenovo LOQ 2024 15ARP9', 'Lenovo', 25990000, 12, TRUE, "New"),
        (12, 'Lenovo ThinkPad E14 Gen 5', 'Lenovo', 23990000, 9, TRUE, "New"),
        (13, 'Dell Precision 7530', 'Dell', 26890000, 41, TRUE, 'Like-New'),
        (14, 'LENOVO THINKPAD P51', 'Lenovo', 26890000, 19, TRUE, 'Like-New'),
        (15, 'ASUS Vivobook 15 R565EA-UH51T', 'Asus', 12700000, 10, TRUE, 'Like-New');
-- pause here

INSERT INTO category (name)
VALUES 	('Hoc-tap-van-phong'), ('Laptop-Gaming'), ('Do-hoa-hieu-nang-cao'), ('Mong-nhe-cao-cap'),

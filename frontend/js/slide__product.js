...
async function fetchCatalog(url) {
    ...
    try {
        ...
        if(url === 'http://10.20.245.24:8080/collections/laptops-category/Hoc-tap-van-phong'){
            slide = document.querySelector('.hoctapvanphongcoban');
        }

        if(url === 'http://10.20.245.24:8080/collections/laptops-category/Laptop-Gaming'){
            slide = document.querySelector('.laptopgaming');
        }

        if(url ==='http://10.20.245.24:8080/collections/laptops-category/Do-hoa-hieu-nang-cao'){
            slide = document.querySelector('.laptopdohoa');
        }

        if(url === 'http://10.20.245.24:8080/collections/laptops-category/Mong-nhe-cao-cap'){
...
async function fetchAllCatalogs() {
    const urls = [
        'http://10.20.245.24:8080/collections/laptops-category/Hoc-tap-van-phong',
        'http://10.20.245.24:8080/collections/laptops-category/Laptop-Gaming',
        'http://10.20.245.24:8080/collections/laptops-category/Do-hoa-hieu-nang-cao',
        'http://10.20.245.24:8080/collections/laptops-category/Mong-nhe-cao-cap'
    ];

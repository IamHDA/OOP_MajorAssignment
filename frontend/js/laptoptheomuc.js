...
async function selectCategoryProduct(){
    ...
    let api = 'http://10.20.245.24:8080/collections/filter?category=' + category + '&brand=' + brand + '&state=' + state + '&cpu&vga&ram&ssd&screenSize&sortBy&sortOrder&minPrice=0&maxPrice=0';    
...
async function seeAll(){
    ...
    let api;
    if(action == "seeAll0"){
        api =  'http://10.20.245.24:8080/collections/laptops-category/Hoc-tap-van-phong';   
        localStorage.setItem('category', "Hoc-tap-van-phong");
    }
    else if(action == "seeAll1"){
        api =  'http://10.20.245.24:8080/collections/laptops-category/Laptop-Gaming';   
        localStorage.setItem('category', "Laptop-Gaming");
    }
    else if(action == "seeAll2"){
        api =  'http://10.20.245.24:8080/collections/laptops-category/Do-hoa-hieu-nang-cao'; 
        localStorage.setItem('category', "Do-hoa-hieu-nang-cao");  
    }
    else{
        api = 'http://10.20.245.24:8080/collections/laptops-category/Mong-nhe-cao-cap';
...
async function getDaTaFilter() {
    ...
    let api = 'http://10.20.245.24:8080/collections/filter?category=' + category + '&brand=' + brand +  '&state=' + state + '&cpu=' + cpu + '&vga=' + vga + '&ram=' + ram + '&ssd=' + ssd + '&screenSize=' + screenSize + '&sortBy=' + sortBy + '&sortOrder=' + sortOrder + '&minPrice=' + minPrice + '&maxPrice=' + maxPrice;

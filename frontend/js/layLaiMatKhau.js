async function layLaiMatKhau(){
    ...
    button.addEventListener("click", async function(){
        ...
        try{
            let response1 = await fetch(`http://10.20.245.24:8080/forgetPassword/checkEmail/${email}`,{
                method: 'GET',
                headers: {
            ...
            if(response1 === "User found"){
                ...
                try{
                    ...
                    let response2 = await fetch(`http://10.20.245.24:8080/forgetPassword/sendMail/${email}`,{
                        method: 'GET',
                        headers: {
                        'Content-Type': 'application/json'
                        }
